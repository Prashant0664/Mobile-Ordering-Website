...
export const fetchphone = async (id) => {
  try {
    const data = await axios.post(
      `${process.env.REACT_APP_BACKEND_URL}/fetchphone`,
      {
        id,
      }
    )
...
export const clearCart = async (id1) => {
  try {
    const data = await axios.post(
      `${process.env.REACT_APP_BACKEND_URL}/clearcart`,
      {
        id1,
      }
    )
...
export const removeitem = async (id1, id2) => {
  try {
    const data = await axios.post(
      `${process.env.REACT_APP_BACKEND_URL}/removeitem`,
      {
        id1,
        id2,
      }
...
export const decreaseitem = async (id1, id2) => {
  try {
    const data = await axios.post(
      `${process.env.REACT_APP_BACKEND_URL}/decreaseitem`,
      {
        id1,
        id2,
      }
...
export const editdetailsuser = async (id, phone, address) => {
  try {
    const data = await axios.post(
      `${process.env.REACT_APP_BACKEND_URL}/editdetailsuser`,
      {
        id, phone, address,
      }
    )
...
export const sendcart = async (id) => {
  try {
    const data = await axios.post(
      `${process.env.REACT_APP_BACKEND_URL}/sendcart`,
      {
        id
      }
    )
